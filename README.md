...
* Joint-EC folder is the implementation of Joint-EC/Joint-ECW model. You need to first gather the predicted results from step 1 model and then run the JointEC.py/JointEC_window file. Note that convert_window_to_normal.py is used to convert the result of Joint-ECW to normal result considering window restriction.
