...
from dataloader_jointEC_torch110 import IEMOCAPDataset
...
class ECPEC(nn.Module):
    ...
    def forward(self, label_ck=None, label3=None, share_rep=False, train=True,
        ...
        if train:
            ...
            return phase2_out, ck_mask, pp_out, label3_out
...
if __name__ == '__main__':
    ...
    #optimizer = optim.NAdam(model.parameters(), lr=args.lr, weight_decay=args.l2)
